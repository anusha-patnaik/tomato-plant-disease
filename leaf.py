...
filepath = "D:\\PROJECTS\\Plant-Leaf-Disease-Prediction-main\\model.h5"
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join("D:\\PROJECTS\\Plant-Leaf-Disease-Prediction-main\\static\\upload", filename)
        file.save(file_path)
